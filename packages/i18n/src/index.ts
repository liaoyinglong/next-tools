...
i18n.loadLocaleData("en", { plurals: defaultPlurals });
i18n.loadLocaleData("in", { plurals: defaultPlurals });
i18n.loadLocaleData("zh", { plurals: defaultPlurals });
i18n.loadLocaleData("bi", { plurals: defaultPlurals });
